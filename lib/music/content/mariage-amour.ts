  ...
  exercises: [
    {
      ...
      lessonId: "B1-01",
      title: "先听见节奏",
      instruction: "看虚拟钢琴示范并听一遍，然后在琴键上原样弹回。",
      mode: "listen",
      eventIds: rightHandEventIds,
      bpm: 75,
      tempoPercent: 50,
      visibleLayers: ["keyboard", "noteNames"],
      inputPolicy: "pitch",
      passCriteria: { pitchAccuracy: 1, repetitions: 1 },
    },
    {
      id: "B1-02",
      lessonId: "B1-02",
      title: "跟上月光节拍",
      instruction: "看五线谱上的色块从右向左移动；到达判定线时，在虚拟钢琴上弹一下。",
      mode: "rhythm",
      eventIds: rightHandEventIds,
      bpm: 60,
      tempoPercent: 40,
      visibleLayers: ["staff", "blocks", "keyboard", "noteNames"],
      inputPolicy: "any-key",
