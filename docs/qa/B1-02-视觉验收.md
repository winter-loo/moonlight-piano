...
- **Source visual truth:** [`reference/B1-02-节奏练习参考.png`](reference/B1-02-节奏练习参考.png)
- **Implementation screenshot:** [`evidence/b1-02-ready.png`](evidence/b1-02-ready.png)
- **Viewport:** 1280 × 720（内置浏览器，横屏）
- **State:** B1-02 初始状态；五线谱、移动色块起点、判定线与虚拟钢琴同时可见
- **Full-view comparison evidence:** [`evidence/b1-02-full-comparison.png`](evidence/b1-02-full-comparison.png)
- **Focused comparison evidence:** [`evidence/b1-02-focused-comparison.png`](evidence/b1-02-focused-comparison.png)
- **Running-state evidence:** [`evidence/b1-02-running.png`](evidence/b1-02-running.png)
